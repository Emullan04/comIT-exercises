let currentDay = prompt("Thanks for contacting Customer Support. As this time, we are only able to provide customer support Monday - Friday, 9am-5pm, Please enter the current day of the week");
...
if (currentWeekday === "SATURDAY" || currentWeekday === "SUNDAY") {
    ...
    if (currentHour < 0 || currentHour > 23 || !currentHour) {
        ...
        alert("Unfortunately, you have reached us outside of office hours, please come back at 0900.");
    } else {
